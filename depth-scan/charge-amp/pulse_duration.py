...
def confidence_plot(position, tau_max, tau_min, tau_med,range_pickle = "pickle_files/tau_range_pickle.pickle", bound_pickle = "pickle_files/full_data_tau_pickle.pickle", recalculate = True):
    if __name__ == "__main__":
        ...
        plt.clf()
        fig, ax = plt.subplots()
        ax.errorbar(tau_array*10**15, beta_2_values, yerr=beta_2_errors, markersize=5, fmt = 'o', color='blue')
        ax.fill_betweenx(y_range, x1=tau_max*10**15, x2=tau_min*10**15, color='lightskyblue', alpha=0.5, label=r"Accepted range")
        ...
        plt.savefig(PREFIX+"shaded_tau.png")
        plt.clf()
